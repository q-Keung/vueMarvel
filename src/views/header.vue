    ...
    <el-row :getter="20">
      ...
      <el-col :span="12">
        <div class="marvel-option">
          <el-input :class="{'more-width': isWidth}" ref="searchInput" placeholder="请输入内容" @blur="isWidth = !isWidth" @focus="isWidth = !isWidth" prefix-icon="el-icon-search" v-model="searchVal"></el-input>
